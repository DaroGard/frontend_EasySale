...
<body>
    ...
    <ul class="nav justify-content-center">
        @foreach ($categorias as $categoria)
            <li class="nav-item">
                <span class="boton-categoria" data-categoria="{{ $categoria->idcategoria }}"
                    onclick="filtrar('{{ $categoria->idcategoria }}')">{{ $categoria->nombrecategoria }}</span>
            </li>
        @endforeach
    </ul>
    <!--Items-->
    <div class="container text-center">
        <div class="row row-cols-3" id="productos-container">
            @foreach ($productos as $producto)
                <div class="col" data-categoria="{{4}}">
