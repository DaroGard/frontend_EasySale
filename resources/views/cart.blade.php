    ...
    <div class="container mt-5">
        <table class="table">
            ...
            <tbody>
                <tr>
                    <th scope="row">1</th>
                    <td><img src="https://th.bing.com/th/id/OIP.ed-29-ckMum--DpdlJRKHgHaFW?rs=1&pid=ImgDetMain"
                            class="img-cart"></td>
                    <td>$200</td>
                    <td><button class="btn btn-outline-danger">-</button>
        ...
        <div class="pay">
            <a type="button" class="btn btn-success" href="{{ route('login-compra') }}"
                onclick="verificarUsuario(event)">Pagar</a>
